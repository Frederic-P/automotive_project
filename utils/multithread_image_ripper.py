...
def download_images(image_urls, folder_loc, max_workers=10, convert_to_jpg=False):
    ...
    - convert_to_jpg (bool): If True, convert .webp images to .jpg format. Default is False.
    ...
    folder_loc = folder_loc.replace(" / ", " _ ")
    ...
    return paths  # Return the list of downloaded image paths