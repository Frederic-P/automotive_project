...
- In case pip ruins the rocm-compatible version of tf, you can revert the clusterfuck with ` pip install tensorflow-rocm==2.17 -f https://repo.radeon.com/rocm/manylinux/rocm-rel-6.3 --upgrade  --force-reinstall `
